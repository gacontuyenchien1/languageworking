-- MCT_CreateTables follow by quyqv design v0.3
-- Create the database
USE MASTER
GO
...
CREATE TABLE dbo.CONTACT(
	...
	ACCOUNT_ID INT FOREIGN KEY REFERENCES dbo.ACCOUNT(ACCOUNT_ID) NOT NULL,
...
CREATE TABLE dbo.CALL_PARTICIPANT(
	...
	GROUP_ID INT  FOREIGN KEY REFERENCES dbo.CALL_GROUP(GROUP_ID) NOT NULL,
	ACCOUNT_ID INT FOREIGN KEY REFERENCES dbo.ACCOUNT(ACCOUNT_ID) NOT NULL,
...
CREATE TABLE dbo.CHAT_MESSAGE(
	...
	ACCOUNT_ID INT FOREIGN KEY REFERENCES dbo.ACCOUNT(ACCOUNT_ID) NOT NULL,
	ROOM_ID INT FOREIGN KEY REFERENCES dbo.CHAT_ROOM(ROOM_ID) NOT NULL,
